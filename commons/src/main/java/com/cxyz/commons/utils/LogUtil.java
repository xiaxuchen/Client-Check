...
public class LogUtil {
     ...
     * @param message
     */
    public static void i_withoutPre(String message){
        if (DEBUG)
            Log.i(TAG,message);
    }
    /**
     ...
     * @param message
     */
    public static void d_withoutPre(String message){
        if (DEBUG)
            Log.d(TAG,message);
    }
    /**
     ...
     * @param message
     */
    public static void v_withoutPre(String message)
    {
        if (DEBUG)
            Log.w(TAG,message);
    }
     ...
     * @param message
     */
    public static void e_withoutPre(String message)
    {
        if (DEBUG)
            Log.e(TAG,message);
    }
     ...
     * @param message
     */
    public static void wtf_withoutPre(String message){
        if (DEBUG)
            Log.wtf(TAG,message);
    }
    /**
     ...
     * @param message
     */
    public static void w_withoutPre(String message){
        if (DEBUG)
            Log.w(TAG,message);
    }
