...
public class AppoitmentAdapter extends BaseAdapter {
    ...
    private List<AppointmentInfo> mData;//定义数据。
    private LayoutInflater mInflater;//定义Inflater,加载我们自定义的布局。
    public AppoitmentAdapter(LayoutInflater inflater,List<AppointmentInfo> data){
        mInflater = inflater;
        mData = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //获得学生对象
        AppointmentInfo studentinfo = mData.get(position);
        //获得自定义布局中每一个控件的对象。
        ...
        Button  button=viewStudent.findViewById(R.id.bt_appointmentstu_check);
        ...
        button.setText("审核中");
        button.setBackgroundColor(R.color.material_grey_300);
